...
- **Admins:** everything a teacher can do, plus user/role management. No public
  sign-up — admins create users.
...
Auth-gated routes live under `src/routes/_auth/`. There is no public sign-up;
`/login` is the only unauthenticated app route.
