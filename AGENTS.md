# AGENTS.md — Agilearn Agent Context (Master Harness)
...
Auth-gated routes live under `src/routes/_auth/`. The unauthenticated app routes
are `/login`, `/signup` (domain-gated teacher onboarding wizard), and
...
## 14. Slash Commands (`.Codex/commands/`)
