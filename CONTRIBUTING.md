...
- **Never add or edit route files.** Do not touch anything under `src/routes/**`
  or `src/routeTree.gen.ts` (it is generated and commit-tracked). Feature work
  happens inside `src/features/<name>/`.
