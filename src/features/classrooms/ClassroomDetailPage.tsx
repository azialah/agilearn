...
const TABS = [
  { label: 'Roster', to: '/classrooms/$classroomId', exact: true },
  { label: 'Grades', to: '/classrooms/$classroomId/grades', exact: false },
  { label: 'Attendance', to: '/classrooms/$classroomId/attendance', exact: false },
  { label: 'Slideshow', to: '/classrooms/$classroomId/slideshow', exact: false },
] as const
